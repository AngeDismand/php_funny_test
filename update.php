...
<div class="row ">
        ...
        <div class="col-9">
        <input type="text" class="form-control shadow-none" name="last_name" id="" value="<?php echo $data['last_name']?>" autofocus required>
    </div>
    </div>
    </div><br>
<div class="form-group">
<div class="row ">
        ...
        <div class="col-9">
        <input type="text" class="form-control shadow-none" name="first_name" value="<?php echo $data['first_name']?>" id="" autofocus required>
    </div>
    </div>
    </div><br>
...
<div class="row ">
        ...
        <div class="col-9">
        <input type="email" class="form-control shadow-none" name="email" id="" value="<?php echo $data['email']?>"autofocus required>
    </div>
    </div>
    </div><br>
    <div class="form-group">
<div class="row ">
        ...
        <div class="col-9">
        <input type="text" class="form-control shadow-none" name="phone_number" id="" value="<?php echo $data['phone_number']?>"autofocus required>
    </div>
    </div>
    </div><br>
    <div class="form-group">
<div class="row ">
        ...
        <div class="col-9">
        <input type="text" class="form-control shadow-none" name="degree" id="" value="<?php echo $data['degree']?>"autofocus required>
    </div>
    </div>
    </div><br>
    <div class="form-group">
<div class="row ">
        ...
        <div class="col-9">
        <input type="file"   accept=".pdf,.doc"class="form-control shadow-none" name="file_name" id="" autofocus required>
    </div>
    </div>
    </div><br>
    <div class="form-group">
...
?> 
    <div class="col-9">
    <button type="submit" class="btn btn-success" name="send"><i class="fa fa-floppy-o">  Save</i></button>
