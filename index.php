...
<table class="table  table-striped">
                    ...
                    <?php foreach($data as $one_data):?>        
                     <tr >
                         ...
                         <a href="download.php?&id=<?php echo $one_data['id']?>"class="btn btn-success mb-2">Download</a>
                        </td>
                         ...
                         <a href="update.php?id=<?php echo $one_data['id']?>"class="btn btn-primary mb-2 ">Edit
                            ...
                            <button type="button" class="btn btn-danger mb-2"
                                data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo $one_data['id'];?>">Delete
                                </button>
